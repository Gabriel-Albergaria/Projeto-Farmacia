 ...
 * @author Gabriel
 */
public class vAreaTrabalho extends javax.swing.JFrame {

    /**
     * Creates new form vAreaTrabalho
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vAreaTrabalho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
